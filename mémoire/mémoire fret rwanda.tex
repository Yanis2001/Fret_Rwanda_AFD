...
\end{equation}
	...
	La méthode utilisée est celle d'une analyse via hypercube latin (HP) (voir \cref{enc:lhs}) sur les paramètres $\beta_s$, la valeur du temps et les taux de conversion $\frac{RWF}{tonne}$ où les incertitudes sont très grandes. 
